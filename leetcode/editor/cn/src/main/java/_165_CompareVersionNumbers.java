...
/**
 * create time: 2021-03-22 22:15:23
 */
public class _165_CompareVersionNumbers {

    private static final Logger logger = Logger.getLogger(_165_CompareVersionNumbers.class.toString());
...
//        logger.warning(String.valueOf(solution.compareVersion("1.01", "1.001")));
    ...
    class Solution {
        public int compareVersion(String version1, String version2) {
            ...
            int i = 0;
            int j = 0;
            while (i < version1String.length || j < version2String.length) {
                int v1;
                int v2;
                if (i >= version1String.length) {
                    v2 = Integer.parseInt(version2String[j]);
                    if (v2 > 0) {
                        return -1;
                    }
                } else if (j >= version2String.length) {
                    v1 = Integer.parseInt(version1String[i]);
                    if (v1 > 0) {
                        return 1;
                    }
                } else {
