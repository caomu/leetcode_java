...
/**
 * create time: 2021-04-07 09:59:03
 */
public class _81_SearchInRotatedSortedArrayIi {

    private static final Logger logger = Logger.getLogger(_81_SearchInRotatedSortedArrayIi.class.toString());

    public static void main(String[] args) {
        long startTimeMillis = System.currentTimeMillis();
        Solution solution = new _81_SearchInRotatedSortedArrayIi().new Solution();

        assert solution.search(new int[]{2, 5, 6, 0, 0, 1, 2}, 0) == true;
        assert solution.search(new int[]{2, 5, 6, 0, 0, 1, 2}, 3) == false;
//        logger.warning(String.valueOf(solution.search(new int[]{2, 5, 6, 0, 0, 1, 2}, 0)));
