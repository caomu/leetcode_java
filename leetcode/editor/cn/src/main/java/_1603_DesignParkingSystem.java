...
/**
 * create time: 2021-03-19 09:41:08
 */
public class _1603_DesignParkingSystem {

    private static final Logger logger = Logger.getLogger(_1603_DesignParkingSystem.class.toString());

    public static void main(String[] args) {
        long startTimeMillis = System.currentTimeMillis();
        ParkingSystem parkingSystem = new _1603_DesignParkingSystem().new ParkingSystem(1, 2, 3);

        // assert solution == ;
        logger.warning(String.valueOf(parkingSystem));
    ...
    class ParkingSystem {
        ...
        public ParkingSystem(int big, int medium, int small) {
            this.parking = new int[]{0, big, medium, small};
        }
