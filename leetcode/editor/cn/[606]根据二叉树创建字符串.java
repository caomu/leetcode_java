...
class Solution {
    ...
    private StringBuilder _tree2str(TreeNode t) {
        ...
        if (t.left != null && t.right != null) {
            res.append("(").append(_tree2str(t.left)).append(")(").append(_tree2str(t.right)).append(")");
        } else if (t.left != null) {
            //&& t.right == null
            res.append("(").append(_tree2str(t.left)).append(")");
        } else if (t.right != null) {
            // t.left == null
            res.append("()(").append(_tree2str(t.right)).append(")");
        }
        // clean current layer
        return res;
    }
